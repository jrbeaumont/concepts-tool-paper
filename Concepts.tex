...
\title{Concepts - A tool for behavioural \\ sepcification of asynchronous circuits}
...
\begin{itemize}
  ...
  \texttt{handshake} concepts, but this includes initial states for the signals. 
   For this concept, both signals will be initialised to 1, or high.
